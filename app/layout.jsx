export const metadata = {
  ...
  keywords:
    'worker management, attendance tracking, wage calculation, project earnings, workforce management, labor record-keeping',
};
    ...
    <html lang="en">
      <head>
        ...
        <link
          ...
          rel="stylesheet"
        />
        {/* dangerouslySetInnerHTML prevents React from HTML-encoding quotes,
            which caused the server/client mismatch hydration error */}
